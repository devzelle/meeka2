...
const Banner = () => {
    ...
    return ( <
        ...
        <
        div className = 'w-75 w-sm-100 banner__section__container' >
        <
        div className = 'my-5 d-flex flex-column flex-md-row justify-content-between align-items-center banner__section w-75'
        style = {
            {
                gap: "1rem"
            }
        ...
        >
        <
        h1 className = 'fw-bold fs-700 w-50 header__text'
        ref = {
            bannerRef
        } >
