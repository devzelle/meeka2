...
const DashboardCards = () => {
    ...
    const dashboardCards = [{
        ...
        },
        {
            cardIcon: dashboardIcon,
            title: "Mainnet Dapp",
            linkText: "to connect to Dapp Mainnet for bridge chain transactions.",
        },
        {
            cardIcon: roundBalls,
            title: "Revoke a Transaction",
            linkText: "If you want to revoke a transaction.",
        },
        {
            cardIcon: roundBalls,
            title: "Mainnet Reload/Irregular token balance",
            linkText: "to Reload wallet balance on the mainnet",
        },
        {
            cardIcon: graphIcon,
    ...
    return ( <
        div className = 'container-fluid d-flex justify-content-center align-items-center mb-5 select__issue__container' >
        <
        div className = 'w-75 w-sm-100 select__issue__content' >
        <
        ...
        ref = {
            ...
            dashboardCards.map((card) => ( <
                div className = 'col-sm-12 col-md-12 col-lg-6 px-0 cards'
                key = {
                    card.title
                } >
                <
                ...
                <
                Card.Body className = 'd-flex flex-column align-items-start dashboard__card__sub'
                style = {
                    {
                        gap: ".5rem"
                    }
                ...
                fluid className = 'dashboard__icon' /
                >
                <
